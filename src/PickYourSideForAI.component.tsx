...
export class PickYourSideForAIComponent extends React.Component<any, any> {
    ...
    onContinuePickYourSideForAIClick = () => {
        this.props.onContinuePickYourSideForAIClick(this.state.selectedOption)
    }
    ...
    public getContinueButton(): React.ReactNode {
        return (
            <div onClick={this.onContinuePickYourSideForAIClick}
                style={{
                    margin: 40,
                    padding: 10,
                    borderRadius: 7,
